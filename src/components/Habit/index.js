...
export default function Habit(){ 
    ...
    function selectDay(day){
        ...
        if (selectedDay.includes(days)) {
            const filteredDays = selectedDay.filter(filterDay => filterDay !== days);
    ...
    function saveHabit(){        
        const promise = axios.post('https://mock-api.bootcamp.respondeai.com.br/api/v2/trackit/habits',{
            ...
            setButtonSave(<Loader type="ThreeDots" color="#FFFFFF" height={15} width={45}/>)
            setSelectedDay([])
            setHabitName("")
            setCreatHabits("none")
        }
            ...
            <Container>
                ...
                <RegisterHabits createHabits = {createHabits}>
                    ...
                    <Buttons>
                        ...
                        <ButtonToSave pointer = {pointerEvent} opacity = {opacityValue} onClick={saveHabit} type="submit">{buttonSave}</ButtonToSave>
                    </Buttons>
                </RegisterHabits>
